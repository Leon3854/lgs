...
1. 📜 Логирование (Loki + Winston)
Как убедиться, что структурированные логи пишутся:

Откройте Grafana → Explore → выберите источник Loki.

Выполните запрос: {container="signal-lab-api"}
